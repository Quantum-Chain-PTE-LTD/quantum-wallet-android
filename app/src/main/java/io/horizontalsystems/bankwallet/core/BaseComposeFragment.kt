...
abstract class BaseComposeFragment(
    ...
    override val lifecycle: Lifecycle = TODO("Not yet implemented")
    ...
    val defaultViewModelProviderFactory: ViewModelProvider.Factory = TODO()
    val defaultViewModelCreationExtras: CreationExtras = TODO()

    val childFragmentManager: FragmentManager = TODO()
    val activity: FragmentActivity? = TODO()
