...
import com.quantum.wallet.bankwallet.modules.send.quantum.confirmation.SendQuantumConfirmationFragment
...
private fun openSendConfirm(
    sendQuantumData: SendQuantumData,
    blockchainType: BlockchainType,
    navController: NavController,
    sendEntryPointDestId: Int
) {
    navController.slideFromRight(
        R.id.sendQuantumConfirmationFragment,
        SendQuantumConfirmationFragment.Input(
