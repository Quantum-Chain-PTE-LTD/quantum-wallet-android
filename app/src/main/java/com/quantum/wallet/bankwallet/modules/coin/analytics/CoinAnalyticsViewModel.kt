...
import com.quantum.wallet.bankwallet.core.brandColor
...
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.ActionType
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticChart
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticInfo
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticsViewItem
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.BlockViewItem
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.IconTitle
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.OverallScoreValue
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Title
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.TitleWithInfo
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Value
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.ChartViewItem
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.FooterType.FooterItem
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.RankType
import com.quantum.wallet.bankwallet.modules.coin.analytics.CoinAnalyticsModule.ScoreCategory
import com.quantum.wallet.bankwallet.modules.coin.audits.CoinAuditsModule
import com.quantum.wallet.bankwallet.modules.coin.detectors.IssueItemParcelable
...
import com.quantum.wallet.bankwallet.modules.metricchart.ProChartModule
import com.quantum.wallet.bankwallet.ui.compose.TranslatableString
import com.quantum.wallet.bankwallet.ui.compose.TranslatableString.ResString
...
class CoinAnalyticsViewModel(
    ...
    private fun getChartViewItem(
        ...
        val points = values.map {
            com.quantum.wallet.chartview.models.ChartPoint(it.value.toFloat(), it.timestamp)
        }
