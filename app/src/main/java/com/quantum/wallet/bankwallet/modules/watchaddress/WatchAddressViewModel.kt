package com.quantum.wallet.bankwallet.modules.watchaddress
...
import com.quantum.wallet.bankwallet.entities.BitcoinAddress
import com.quantum.wallet.bankwallet.entities.DataState
import com.quantum.wallet.bankwallet.entities.MoneroWatchAddress
import com.quantum.wallet.bankwallet.entities.tokenType
...
class WatchAddressViewModel(
    ...
    private fun addressType(address: Address) = when (address.blockchainType) {
        ...
        BlockchainType.QuantumChain -> Type.EvmAddress
