...
import com.quantum.wallet.bankwallet.core.coinIconUrl
...
import com.quantum.wallet.bankwallet.modules.multiswap.providers.MayaProvider
import com.quantum.wallet.bankwallet.modules.multiswap.providers.MultiSwapProviderRegistry
...
class SwapInfoViewModel(
    ...
    private fun buildTxUrl(blockchainTypeUid: String, txHash: String): String? =
        when (BlockchainType.fromUid(blockchainTypeUid)) {
            ...
            BlockchainType.QuantumChain -> "https://qntmscan.io/tx/$txHash"
