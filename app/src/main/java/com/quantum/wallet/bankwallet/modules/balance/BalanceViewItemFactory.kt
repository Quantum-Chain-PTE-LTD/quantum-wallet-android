...
import com.quantum.wallet.bankwallet.core.diff
...
import com.quantum.wallet.bankwallet.modules.balance.BalanceModule.warningText
...
class BalanceViewItemFactory {
    ...
    private fun getDefaultSyncingProgress(blockchainType: BlockchainType) = when (blockchainType) {
        ...
        BlockchainType.Ton,
        BlockchainType.QuantumChain -> 50
